...
export default function Header({
  ...
  return (
    <header className="mb-8 flex items-center justify-between rounded-lg shadow-lg p-4 bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 text-white animate-fade-in">
